package com.lixue.aibei.changeskinlib.base;
...
import com.lixue.aibei.changeskinlib.attr.SkinAttr;
...
//        LayoutInflater layoutInflater = getLayoutInflater();
    ...
    public View createViewFromTag(Context context,String name,AttributeSet attributeSet){
        if (name.equals("view")) {
    ...
    public void injectSkin(View v,List<SkinAttr> skinAttrList){
        if (skinAttrList != null && skinAttrList.size() > 0){
            ...
            skinViews.add(new SkinView(v,skinAttrList));
